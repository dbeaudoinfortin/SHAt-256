...
/**
 * Copied and modified from sun.security.provider of JDK 1.8
 */
...
public abstract class DigestBase extends MessageDigestSpi implements Cloneable {
     ...
     * Main constructor.
     */
    protected DigestBase(String algorithm, int digestLength, int blockSize) {
        super();
     ...
     */
    protected DigestBase(DigestBase base) {
     ...
     */
    protected abstract void implCompress(byte[] b, int ofs);

    /**
     * Return the digest. Subclasses do not need to reset() themselves,
     * DigestBase calls implReset() when necessary.
     */
    protected abstract void implDigest(byte[] out, int ofs);

    /**
     * Reset subclass specific state to their initial values. DigestBase
     * calls this method when necessary.
     */
    protected abstract void implReset();
